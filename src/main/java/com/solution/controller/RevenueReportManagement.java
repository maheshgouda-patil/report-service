...
@RestController
@RequestMapping(com.solution.constants.UrlConstants.REVENUE)
public class RevenueReportManagement {
  ...
  public ResponseEntity<ResponseBo> fetchReport(@PathVariable("companyId") int companyId) throws SolutionException {
	  ...
	  responseBo.setResponse(reportService.fetchRevenueReport(companyId));
