...
@RestController
@RequestMapping(com.solution.constants.UrlConstants.PROFIT)
public class ProfitReportManagement {
  ...
  public ResponseEntity<ResponseBo> fetchReport(@PathVariable("companyId") int companyId) throws SolutionException {
	  ...
	  responseBo.setResponse(reportService.fetchProfiltReport(companyId));
